        ...
        >
          ...
          <div className="hist-row">
            {snaps.map((snap, idx) => {
              ...
              else if (snap.type === "stuck")
                label = t("snapLabels.stuck", { step: snap.step });
              ...
              {stopBox.type === "solved" ? (
                ...
                <>
                  <AlertTriangle
                    ...
                    style={{ display: "inline", marginBottom: "-2px" }}
                  />{" "}
                  <b>{t("stopBox.localOptimum")}</b>
                  <br />
                  {t("stopBox.localDetail", {
                    hv: stopBox.hv,
                    bestH: stopBox.bestH,
                  })}
                  <br />
